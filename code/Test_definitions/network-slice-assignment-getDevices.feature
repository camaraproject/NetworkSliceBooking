Feature: CAMARA Network Slice Assignment API v0.1.0 - Operation getDevices
  ...
  Background: Common getDevices setup
    ...
    And the path parameter "sliceId" is set by default to a existing network slice id

# Success scenarios

  @network_slice_booking_getDevices_01_generic_success_scenario
  Scenario: Query the bound devices under the slice resouce
    Given a slice id of a device that has already been bound
    When the request "getDevices" is sent
  ...
  @network_slice_booking_getDevices_02_invalid_argument_scenario
  ...
  @network_slice_booking_getDevices_03_out_of_range_scenario
  ...
  @network_slice_booking_getDevices_04_missing_authorization_scenario
  ...
  Scenario: Missing access token scope
    Given the header "Authorization" is set to an access token that does not include scope network-slice-assignment:devices:get
    When the request "getDevices" is sent
  ...
  @network_slice_booking_getDevices_06_server_resource_not_found_scenario
  ...
  @network_slice_booking_getDevices_08_service_not_applicable_scenario
  ...
  @network_slice_booking_getDevices_11_too_many_requests_scenario
