Feature: CAMARA Network Slice Assignment API v0.1.0-rc.1 - Operation release
    ...
    # Testing assets:
	# * The AssignmentInfo of an existing Slice assignment
	# * The AssignmentInfo of an existing Slice assignment with status "AVAILABLE", and with provided values for "sink" and "sinkCredential"
	#
  ...
  Background: Common releaseSlice setup
    ...
    And the resource "/network-slice-assignment/v0.1rc1/slices/devices/release"
    ...
    And the path parameter "device" is set by default to a existing network slice id

# Success scenarios

  @network_slice_booking_releaseSlice_01_generic_success_scenario
  Scenario: Release the slice resources that have been allocated to the device
    Given a valid testing device that has been allocated slices
    When the request "releaseSlice" is sent
  ...
  @network_slice_booking_releaseSlice_02_invalid_argument_scenario
  ...
  @network_slice_booking_releaseSlice_03_out_of_range_scenario
  ...
  @network_slice_booking_releaseSlice_04_missing_authorization_scenario
  ...
  @network_slice_booking_releaseSlice_05_missing_access_token_scope_scenario
  Scenario: Missing access token scope
    Given the header "Authorization" is set to an access token that does not include scope network-slice-booking:slices:assign
    When the request "releaseSlice" is sent
  ...
  @network_slice_booking_releaseSlice_06_server_resource_not_found_scenario
  ...
  @network_slice_booking_releaseSlice_07_business_resource_not_found_scenario
  ...
  @network_slice_booking_releaseSlice_08_service_not_applicable_scenario
  ...
  @network_slice_booking_releaseSlice_09_inapposite_identifier_scenario
  ...
  @network_slice_booking_releaseSlice_10_quota_exceeded_scenario
  ...
  @network_slice_booking_releaseSlice_11_too_many_requests_scenario
