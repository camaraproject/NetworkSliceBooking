Feature: CAMARA Network Slice Assignment API v0.1.0 - Operation assignDevice
  ...
  Background: Common assignDevice setup
    ...
    And the resource "/network-slice-assignment/v0.1/slices/{sliceId}/devices"
...
# Success scenarios
  ...
  @network_slice_booking_assignDevice_01_generic_success_scenario
  Scenario: Common validations for any success scenario
    Given a valid testing device supported by the service and slice id have already been allocated
    When the request "assignDevice" is sent
  ...
  @network_slice_booking_assignDevice_02_invalid_argument_scenario
  ...
  @network_slice_booking_assignDevice_03_out_of_range_scenario
  ...
  @network_slice_booking_assignDevice_04_missing_authorization_scenario
  ...
  Scenario: Missing access token scope
    Given the header "Authorization" is set to an access token that does not include scope network-slice-assignment:devices:assign
    When the request "assignDevice" is sent
  ...
  @network_slice_booking_assignDevice_07_business_resource_not_found_scenario
  ...
  @network_slice_booking_assignDevice_08_service_not_applicable_scenario
  ...
  @network_slice_booking_assignDevice_09_inapposite_identifier_scenario
  ...
  @network_slice_booking_assignDevice_10_quota_exceeded_scenario
  ...
  @network_slice_booking_assignDevice_11_too_many_requests_scenario
