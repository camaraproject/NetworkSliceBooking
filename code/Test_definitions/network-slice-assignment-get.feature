Feature: CAMARA Network Slice Assignment API v0.1.0 - Operation get
  ...
  Background: Common getDevice setup
    ...
    And the resource "/network-slice-assignment/v0.1/slices/devices/get/{sliceId}"
...
# Success scenarios
  ...
  @network_slice_booking_getDevice_03_out_of_range_scenario
  ...
  @network_slice_booking_getDevice_04_missing_authorization_scenario
  ...
  @network_slice_booking_getDevice_05_missing_access_token_scope_scenario
  ...
  @network_slice_booking_getDevice_10_quota_exceeded_scenario
  ...
  @network_slice_booking_getDevice_11_too_many_requests_scenario
