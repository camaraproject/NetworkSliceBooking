Feature: CAMARA Network Slice Assignment API v0.1.0 - Operation releaseDevice
  ...
  Background: Common releaseDevice setup
    ...
    And the resource "/network-slice-assignment/v0.1/slices/{sliceId}/release"
...
# Success scenarios
  ...
  @network_slice_booking_releaseDevice_01_generic_success_scenario
  Scenario: Release the slice resources that have been allocated to the device
    ...
    When the request "releaseDevice" is sent
  ...
  @network_slice_booking_releaseDevice_02_invalid_argument_scenario
  ...
  @network_slice_booking_releaseDevice_03_out_of_range_scenario
  ...
  @network_slice_booking_releaseDevice_05_missing_access_token_scope_scenario
  Scenario: Missing access token scope
    Given the header "Authorization" is set to an access token that does not include scope network-slice-assignment:devices:delete
    When the request "releaseDevice" is sent
  ...
  @network_slice_booking_releaseDevice_06_server_resource_not_found_scenario
  ...
  @network_slice_booking_releaseDevice_07_business_resource_not_found_scenario
  ...
  @network_slice_booking_releaseDevice_08_service_not_applicable_scenario
  ...
  @network_slice_booking_releaseDevice_09_inapposite_identifier_scenario
  ...
  @network_slice_booking_releaseDevice_10_quota_exceeded_scenario
  ...
  @network_slice_booking_releaseDevice_11_too_many_requests_scenario
