Feature: CAMARA Network Slice Assignment API v0.1.0-rc.1 - Operation retrieve
  ...
  Background: Common retrieveSlice setup
    ...
    And the resource "/network-slice-assignment/v0.1rc1/slices/devices/retrieve"
...
# Success scenarios
  ...
  @network_slice_booking_retrieveSlice_02_invalid_argument_scenario
  ...
  @network_slice_booking_retrieveSlice_03_out_of_range_scenario
  ...
  @network_slice_booking_retrieveSlice_04_missing_authorization_scenario
  ...
  @network_slice_booking_retrieveSlice_05_missing_access_token_scope_scenario
  ...
  @network_slice_booking_retrieveSlice_10_quota_exceeded_scenario
  ...
  @network_slice_booking_retrieveSlice_11_too_many_requests_scenario
