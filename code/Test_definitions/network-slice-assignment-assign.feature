Feature: CAMARA Network Slice Assignment API v0.1.0-rc.1 - Operation assign
  ...
  Background: Common assignSlice setup
    Given an environment at "apiRoot"
    And the resource "/network-slice-assignment/v0.1rc1/slices/devices/assign"
...
# Success scenarios
  ...
  @network_slice_booking_assignSlice_03_out_of_range_scenario
  ...
  @network_slice_booking_assignSlice_04_missing_authorization_scenario
  ...
  @network_slice_booking_assignSlice_05_missing_access_token_scope_scenario
  ...
  @network_slice_booking_assignSlice_10_quota_exceeded_scenario
  ...
  @network_slice_booking_assignSlice_11_too_many_requests_scenario
